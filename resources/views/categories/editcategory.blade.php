            ...
            <form method="post" action="{{ route('update-category', $category->id) }}">
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <input type="text" name="name" value="{{ old('name', $category->name) }}" class="form-control shadow-lg" placeholder="Enter category name" id="name">
                ...
                <div class="row g-4 mt-3">
                    <div class="col-md-12">
                        ...
                        <textarea name="description" class="form-control shadow-lg" rows="4" placeholder="Enter a description for this category" id="description">{{ old('description', $category->description) }}</textarea>
                ...
                <div class="d-flex justify-content-center mt-5">
                    <button type="submit" class="btn btn-success btn-lg px-5 shadow-lg">
                        <i class="bi bi-cloud-upload-fill me-2"></i> Update Category
                    </button>
                </div>
            </form>
        </div>
