...
<div class="container mt-5">
  ...
  <div class="card shadow-lg border-0 rounded-4">
      ...
      <div class="card-body p-5">
          <form method="post" action="{{ route('add-product') }}" enctype="multipart/form-data" id="product-form">
              @csrf
              <!-- Title & Price -->
              <div class="row g-4">
                  <div class="col-md-6">
                      <label for="title" class="form-label fw-bold">Product Title</label>
                      <input type="text" name="title" value="{{ old('title') }}" class="form-control shadow-lg" placeholder="Enter product title" id="title">
                  </div>
              ...
              <div class="row g-4 mt-3">
                  <div class="col-md-6">
                      ...
                      <textarea name="description" class="form-control shadow-lg" rows="4" placeholder="Brief description of the product" id="description">{{ old('description') }}</textarea>
                  ...
                  <div class="col-md-6">
                      ...
                      <input type="text" name="sku" value="{{ old('sku') }}" class="form-control shadow-lg" placeholder="Enter SKU" id="sku">
              ...
              <div class="row g-4 mt-3">
                  ...
                  <div class="col-md-6">
                      ...
                      <div class="form-text">Upload a high-quality image (JPG, PNG, or JPGE).</div>
                  </div>
              </div>
              ...
              <div class="d-flex justify-content-center mt-5">
                  <button type="submit" class="btn btn-success btn-lg px-5 shadow-lg">
                      <i class="bi bi-cloud-upload-fill me-2"></i> Add Product
                  </button>
              </div>
          </form>
      </div>
